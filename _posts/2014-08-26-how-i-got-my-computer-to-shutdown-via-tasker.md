...
- Download [TaskerSlave](https://github.com/headdetect/TaskerSlave) for [windows](https://github.com/headdetect/TaskerSlave/releases/download/v1.0/win.zip)/mac/linux.
